...
return [
    ...
    */
    ...
    | application if they have at least one of the specified role.
    |
    */

    // WARNING: This feature makes one request to the Discord API for each guild you specify. (Because you need to fetch the role for each guild)
    ...
    */
    ...
    'error_messages' => [
        ...
        'authorization_failed_roles' => [
            'message' => 'Couldn\'t get the role you have.',
            'redirect' => '/'
        ],
        'missing_role' => [
