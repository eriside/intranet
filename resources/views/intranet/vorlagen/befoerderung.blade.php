...
<body>
    ...
    <div class="content">
        ...
        <div style="position: absolute; left: 60px; top: 420px; padding-right: 100px;">
            <p style="font-size: 18px"><strong>Beförderungsschreiben</strong></p>
            ...
            <p style="font-size: 12px; margin-top: 40px">wir freuen uns Ihnen mitteilen zu dürfen, dass Sie aufgrund von positivem und aktivem Auftreten innerhalb der Berufsfeuerwehr befördert werden.</p>
            <p class="center" style="font-size: 12px; margin-top: 50px">Sie werden vom Rang {{$old}} zum Rang {{$new}} befördert.</p>
            <p style="font-size: 12px; margin-top: 50px">Somit sind Sie jetzt anerkannter {{$new}} in der Berufsfeuerwehr Rheinstadt.</p>
