...
<body>
    ...
    <div class="content">
        ...
        <div style="position: absolute; left: 60px; top: 420px; padding-right: 100px;">
            <p style="font-size: 18px"><strong>Abmahnung</strong></p>
            ...
            <p style="font-size: 14px; margin-top: 40px">ihr Verhalten veranlasst uns, Sie auf die ordnungsgemäße Erfüllung Ihrer arbeitsvertraglichen Pflichten hinzuweisen. Wir müssen Sie leider abmahnen, da {{$grund}}.</p>
            <p style="font-size: 14px; margin-top: 20px">Sollte sich eine derartige oder gleichartige Pflichtverletzung wiederholen, müssen Sie mit weiteren arbeitsrechtlichen Konsequenzen rechnen, bis hin zu einer Kündigung des Arbeitsverhältnisses. </p>
            <p style="font-size: 14px; margin-top: 20px">Eine Ausfertigung dieser Abmahnung werden wir Ihrer Personalakte beifügen. Gleichzeitig weisen wir drauf hin, dass wir in Ihrem Fall @if($law == 0) keine @endif rechtlichen Schritte Schritte einleiten werden.</p>
            <p style="font-size: 14px; margin-top: 40px">Mit freundlichen Grüßen</p>
            ...
            <p style="font-size: 14px; margin-top: 40px">Diese Abmahnung ist mir am 06.05.2025 ausgehändigt worden. Ich habe den Inhalt zur Kenntnis genommen.</p>
            <table style="width: 40%; margin-top: 40px">
                <tr>
