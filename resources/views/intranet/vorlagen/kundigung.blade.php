...
<body>
    ...
    <div class="content">
        ...
        <div style="position: absolute; left: 60px; top: 420px; padding-right: 100px;">
            <p style="font-size: 18px"><strong>Kündigung des Arbeitsverhältnisses</strong></p>
            ...
            <p style="font-size: 14px; margin-top: 40px">hiermit kündigen wir Ihnen das aktuell bestehende Arbeitsverhältnis vom {{$einstellung}} ordentlich und fristgerecht zum {{\Carbon\Carbon::now()->addWeeks(2)->format('d.m.y')}}. Wir sehen uns zu diesem Schritt aufgrund von {{$grund}} gezwungen.</p>
