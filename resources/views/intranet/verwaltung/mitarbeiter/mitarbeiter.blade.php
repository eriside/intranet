    ...
    @if($roles->contains('Mitarbeiter'))
        <div class="container my-5">
            ...
            <div class="d-flex justify-content-center gap-2 flex-wrap">
                ...
                <a href="{{url('/intranet/verwaltung/mitarbeiter/new')}}" class="btn btn-success" >Neuer Mitarbeiter</a>
            </div>
        </div>
        ...
        <div class="row mt-4 d-flex justify-content-center align-items-stretch">
            @foreach($mitarbeiter as $mitarbeiter)
                    @if($mitarbeiter->aktiv)
                        <div class="col-11 col-md-4 col-lg-3 mx-2 mb-4" data-title="{{$mitarbeiter->name}} {{$mitarbeiter->dienstnummer}} ">
